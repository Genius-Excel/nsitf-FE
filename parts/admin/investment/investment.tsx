...
const contributionsTrendData = [
  ...
  },
  {
    period: "Feb",
    private: 48000000,
    publicTreasury: 34000000,
    publicNonTreasury: 19500000,
    informal: 9200000,
  },
  {
    period: "Mar",
  ...
  },
  {
    period: "Apr",
    private: 49500000,
    publicTreasury: 36000000,
    publicNonTreasury: 20500000,
    informal: 9800000,
  },
  {
    period: "May",
    private: 54000000,
    publicTreasury: 38000000,
    publicNonTreasury: 22000000,
    informal: 11000000,
  },
  {
    period: "Jun",
...
const feesCollectionData = [
  {
    ...
    ecsCertificate: 950000,
  },
  {
    period: "Feb",
    rental: 2650000,
    ecsRegistration: 1920000,
    ecsCertificate: 1020000,
  },
  {
    period: "Mar",
    rental: 2800000,
  ...
  },
  {
    period: "Apr",
    rental: 2720000,
    ecsRegistration: 2050000,
    ecsCertificate: 1080000,
  },
  {
    period: "May",
    rental: 2950000,
    ecsRegistration: 2200000,
    ecsCertificate: 1200000,
  },
  {
    period: "Jun",
    rental: 3100000,
    ...
    <div className="space-y-10">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Monitor contribution collections, fees, and financial performance
            across all sectors
          </p>
        </div>
          ...
          <Dialog open={uploadDialogOpen} onOpenChange={setUploadDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[525px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Upload financial data for contribution collections and fees.
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <Card className="col-span-2 p-6">
          <div className="mb-4">
            ...
            <p className="text-muted-foreground mt-1">
              Monthly contribution collections across all sectors
            </p>
          </div>
      ...
      <Card>
        <div className="p-6 border-b">
          ...
          <p className="text-muted-foreground mt-1">
            Complete ledger of all contribution collections and fees
          </p>
        </div>
              ...
              {paginatedRecords.map((record, index) => (
                ...
                >
                  ...
                  <TableCell className="text-right">
                    {formatCurrency(record.privateSector)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatCurrency(record.publicTreasury)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatCurrency(record.publicNonTreasury)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatCurrency(record.informalEconomy)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatCurrency(record.rentalFees)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatCurrency(record.ecsRegistration)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatCurrency(record.ecsCertificate)}
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        record.status === "validated" ? "default" : "secondary"
                      }
                      className={
        ...
        <div className="flex items-center justify-between p-4 border-t">
          <p className="text-muted-foreground">
            ...
            {Math.min(currentPage * itemsPerPage, financialRecords.length)} of{" "}
