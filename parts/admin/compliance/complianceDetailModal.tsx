        ...
        >
          ...
          <div className="p-4 sm:p-6 space-y-6">
            ...
            <section aria-labelledby="metrics-heading">
              <h3 id="metrics-heading" className="sr-only">Financial Metrics</h3>
            ...
            {/* Target Status */}
            {!isTargetMet && (
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4" role="status">
            ...
            <section aria-labelledby="employment-heading">
              <h3 id="employment-heading" className="text-sm font-semibold text-gray-900 mb-3">
                Employment Data
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <p className="text-xs text-gray-600 uppercase mb-1">Total Employers</p>
            ...
            <section aria-labelledby="additional-heading">
              <h3 id="additional-heading" className="text-sm font-semibold text-gray-900 mb-3">
                Additional Information
              </h3>
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 space-y-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-semibold text-gray-900">{entry.region}</span>
                </div>
                <div className="flex justify-between items-center">
