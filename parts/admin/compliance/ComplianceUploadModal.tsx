// ============================================================================
// ComplianceUploadModal - Refactored
// ============================================================================
...
export const ComplianceUploadModal: React.FC<ComplianceUploadModalProps> = ({
  isOpen,
  onClose,
  onUploadSuccess,
}) => {
  ...
  const handleDownloadTemplate = () => {
    ...
    const fileName = selectedBranch
      ? `${selectedBranch.name}_Compliance_Template.xlsx`
      : selectedRegion
      ? `${selectedRegion.name}_Compliance_Template.xlsx`
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      toast.success(`Successfully uploaded ${recordCount} compliance records!`);
